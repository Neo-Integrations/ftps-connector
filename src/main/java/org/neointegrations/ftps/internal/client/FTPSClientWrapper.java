...
public class FTPSClientWrapper implements AutoCloseable {
    private static final Logger _logger = LoggerFactory.getLogger(FTPSClientWrapper.class);
    ...
    public FTPSClientWrapper(final boolean isImplicit,
